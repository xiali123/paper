...
ROUTES=(
    ...
    "POST|/api/latex/projects/1/upload|{}|200,400,404|Upload file to project"
    "POST|/api/latex/projects/1/batch-upload|{}|200,400,404|Batch upload files to project"
    "POST|/api/latex/projects/1/import|{\"source\":\"test\"}|200,404|Import project"
    ...
    "POST|/api/latex/versions/save|{\"documentId\":1,\"content\":\"test\"}|200,404|Save version"
    "POST|/api/latex/versions/restore|{\"versionId\":1}|200,404|Restore version"
    "POST|/api/latex/versions/branch|{\"versionId\":1,\"name\":\"feature\"}|200,404|Create version branch"
