...
// Lazy-loaded: only fetched when the dialog/drawer opens
const ShortcutHelpDialog = defineAsyncComponent(() => import('./latex/components/dialogs/ShortcutHelpDialog.vue'))
const QuickInsertDialog = defineAsyncComponent(() => import('./latex/components/dialogs/QuickInsertDialog.vue'))
const AiRecognizerDialog = defineAsyncComponent(() => import('./latex/components/dialogs/AiRecognizerDialog.vue'))
const ReviewModeDialog = defineAsyncComponent(() => import('./latex/components/dialogs/ReviewModeDialog.vue'))
const ExportDialogWrapper = defineAsyncComponent(() => import('./latex/components/dialogs/ExportDialogWrapper.vue'))
const WelcomeGuideDialog = defineAsyncComponent(() => import('./latex/components/dialogs/WelcomeGuideDialog.vue'))
const CollaborationPanel = defineAsyncComponent(() => import('@/components/collaboration/CollaborationPanel.vue'))
const VersionHistory = defineAsyncComponent(() => import('@/components/latex/VersionHistory.vue'))
const VersionControl = defineAsyncComponent(() => import('@/components/latex/VersionControl.vue'))
const RecentDocuments = defineAsyncComponent(() => import('@/components/latex/RecentDocuments.vue'))
const EditorSettings = defineAsyncComponent(() => import('@/components/latex/EditorSettings.vue'))
const StatsDashboard = defineAsyncComponent(() => import('@/components/latex/StatsDashboard.vue'))
const SymbolPanel = defineAsyncComponent(() => import('./latex/components/panels/SymbolPanel.vue'))
const SnippetsPanel = defineAsyncComponent(() => import('./latex/components/panels/SnippetsPanel.vue'))
const TemplatesPanel = defineAsyncComponent(() => import('./latex/components/panels/TemplatesPanel.vue'))
const TablePanel = defineAsyncComponent(() => import('./latex/components/panels/TablePanel.vue'))
const SpellCheckPanel = defineAsyncComponent(() => import('./latex/components/panels/SpellCheckPanel.vue'))
const FontPanel = defineAsyncComponent(() => import('./latex/components/panels/FontPanel.vue'))
const InlineCommentSystem = defineAsyncComponent(() => import('@/components/latex/InlineCommentSystem.vue'))
const CommandPalette = defineAsyncComponent(() => import('@/components/latex/CommandPalette.vue'))
