...
class LatexBibtexManager;
class LatexDocumentOutline;
class LatexSymbolPalette;
class LatexWordCounter;
class ApiManager;
class QToolBar;
class QLineEdit;
...
private:
    ...
    LatexBibtexManager* bibtexManager_{nullptr};
    LatexDocumentOutline* documentOutline_{nullptr};
    LatexSymbolPalette* symbolPalette_{nullptr};
    LatexWordCounter* wordCounter_{nullptr};
