...
void MainWindow::createMenus() {
    ...
    toolsMenu->addAction("Rhetoric Analyzer", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperRhetoricAnalyzer();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    ...
    toolsMenu->addAction("Radial Bar Chart", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperRadialBarChart();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    toolsMenu->addAction("Seminar Scheduler", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperSeminarScheduler();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    toolsMenu->addAction("Metric Exporter", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperMetricExporter();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    ...
    toolsMenu->addAction("Argument Scorer", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperArgumentScorer();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    toolsMenu->addAction("Bookmark Vault", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperBookmarkVault();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    toolsMenu->addAction("Marimekko 2", this, [this]() {
        auto* dlg = new QDialog(this);
        dlg->setWindowTitle("Marimekko 2");
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperMarimekko2();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    ...
    toolsMenu->addAction("Citation Binder", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperCitationBinder();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    toolsMenu->addAction("Highlight Collector", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperHighlightCollector();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    toolsMenu->addAction("Waterfall 2", this, [this]() {
        auto* dlg = new QDialog(this);
        dlg->setWindowTitle("Waterfall 2");
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperWaterfall2();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    ...
    toolsMenu->addAction("Reading Voyage", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperReadingVoyage2();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    ...
    toolsMenu->addAction("Log Aggregator", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperLogAggregator2();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    ...
    toolsMenu->addAction("Topic Sentinel", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperTopicSentinel2();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
    toolsMenu->addAction("Reading Endurance", this, [this]() {
        ...
        dlg->setMinimumSize(600, 500);
        auto* layout = new QVBoxLayout(dlg);
        auto* w = new PaperReadingEndurance2();
        layout->addWidget(w);
        dlg->exec();
        dlg->deleteLater();
    });
...
void MainWindow::connectSignals() {
    ...
    commandPalette_->addAction("Marimekko 2", "", "Tools", [this]() {
        ToastWidget::showInfo("Open Tools > Marimekko 2");
    });
    ...
    commandPalette_->addAction("Waterfall 2", "", "Tools", [this]() {
        ToastWidget::showInfo("Open Tools > Waterfall 2");
    });
